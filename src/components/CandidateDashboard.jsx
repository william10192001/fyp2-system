                  ...
                  {activeDetail === "description" ? (
                    ...
                    <div style={{ fontSize: 13 }}>
                      ...
                      <div style={{ marginBottom: 20 }}>
                        <div style={{ fontWeight: 600, color: "#111827", fontSize: 14, marginBottom: 12 }}>🏢 About the Company</div>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                          {[
                            ...
                            <div key={label} style={{ background: "#f9fafb", borderRadius: 10, padding: "12px 14px" }}>
                              ...
                              <div style={{ color: "#111827", fontWeight: 500 }}>{val}</div>
                            </div>
                          ))}
                        </div>
                        {selectedJob.companyDescription && (
                          <div style={{ background: "#f9fafb", borderRadius: 10, padding: "14px 16px" }}>
                            <div style={{ color: "#9ca3af", fontSize: 11, marginBottom: 6 }}>Company Description</div>
                            <div style={{ color: "#374151", lineHeight: 1.7 }}>{selectedJob.companyDescription}</div>
                          </div>
                        )}
                        {!selectedJob.companyDescription && (
                          <div style={{ color: "#9ca3af", fontSize: 12, fontStyle: "italic" }}>No company description provided.</div>
                        )}
                      </div>
                      {/* Benefits */}
                      <div>
                        <div style={{ fontWeight: 600, color: "#111827", fontSize: 14, marginBottom: 12 }}>🎁 Benefits & Perks</div>
                        {selectedJob.benefits ? (
                          <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 10, padding: "14px 16px" }}>
                            <div style={{ color: "#166534", lineHeight: 1.8, whiteSpace: "pre-wrap" }}>{selectedJob.benefits}</div>
                          </div>
                        ) : (
                          <div style={{ color: "#9ca3af", fontSize: 12, fontStyle: "italic" }}>No benefits information provided.</div>
                        )}
                      </div>
                    </div>
                  )}
